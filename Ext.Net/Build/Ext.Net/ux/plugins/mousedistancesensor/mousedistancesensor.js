 ...
 ********/
 ...
 Ext.ux.MouseDistanceSensor = Ext.extend(Ext.util.Observable, {
    opacity    : true,
    minOpacity : 0,
    maxOpacity : 1,
    threshold  : 100,
    ...
    constructor : function (config) {
        ...
        this.initEvents();
        Ext.ux.MouseDistanceSensor.superclass.constructor.call(this);             
    },
    ...
    getSensorEls : function () {
        return this.component.getPositionEl();
    },
    ...
    onMouseMove : function (e) {
        ...
        if (this.isOutConstrain(e.getXY())) {
            if (this.state !== "far") {
                this.state = "far";
        ...
        var dObj = this.getDistance(e.getXY());
