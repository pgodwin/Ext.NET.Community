 ...
 */
Ext.ux.Reorderer = Ext.extend(Ext.util.Observable, {
    /**
     * @property defaults
     * @type Object
    ...
    constructor: function (config) {
        ...
        this.initEvents();
        Ext.ux.Reorderer.superclass.constructor.call(this);
    },
    ...
    reorder: function (mappings) {
        ...
        if (this.fireEvent('beforereorder', mappings, target, this) !== false) {
            this.doReorder(mappings);
            
            this.fireEvent('reorder', mappings, target, this);
        }
    },
            ...
            endDrag: function () {
                ...
                el.moveTo(me.buttonXCache[button.id], el.getY(), {
                    ...
                    callback: function () {
                        ...
                        me.fireEvent('reorder', button, tbar);
                    }
                });
